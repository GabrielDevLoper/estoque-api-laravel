...
@section('content')
    <!-- page title -->
    <x-page-title title="Produtos" pagetitle="Estoque"/>
        ...
        <div class="card-body">
            <div class="grid grid-cols-1 gap-4 lg:grid-cols-2 xl:grid-cols-12">
                ...
                <div class="lg:col-span-2 ltr:lg:text-right rtl:lg:text-left xl:col-span-2 xl:col-start-11">
                    <button data-modal-target="produtoModal" type="button"
                            class="text-white btn bg-custom-500 border-custom-500 hover:text-white hover:bg-custom-600 hover:border-custom-600 focus:text-white focus:bg-custom-600 focus:border-custom-600 focus:ring focus:ring-custom-100 active:text-white active:bg-custom-600 active:border-custom-600 active:ring active:ring-custom-100 dark:ring-custom-400/20">
                        <i
                            data-lucide="plus" class="inline-block w-4 h-4"></i> <span class="align-middle">Novo</span>
                    </button>
                </div>
            </div><!--end grid-->
        </div>
            ...
            <div class="overflow-x-auto">
                <table class="w-full whitespace-nowrap" id="productTable">
                    ...
                    @foreach($produtos as $index => $produto)
                        <tr>
                            <td class="px-3.5 py-2.5 border-y border-slate-200 dark:border-zink-500 product_code">
                                {{$produto->id}}
                            </td>
                            ...
                            <td class="px-3.5 py-2.5 border-y border-slate-200 dark:border-zink-500 quantity">
                            ...
                            <td class="px-3.5 py-2.5 border-y border-slate-200 dark:border-zink-500">
                                <a href="#!" data-modal-target="modalMovimentar{{$index}}"
                                   class="flex items-center justify-center w-8 h-8 transition-all duration-200 ease-linear rounded-md edit-item-btn bg-slate-100 text-slate-500 hover:text-custom-500 hover:bg-custom-100 dark:bg-zink-600 dark:text-zink-200 dark:hover:bg-custom-500/20 dark:hover:text-custom-500">
                                    <i data-lucide="package-plus"
                                       class="inline-block w-4 h-4 text-sky-500 fill-sky-100 dark:fill-sky-500/20"></i>
                                </a>
                            </td>
                            <td class="px-3.5 py-2.5 border-y border-slate-200 dark:border-zink-500">
                                <div class="flex gap-2">
                                    <a class="flex items-center justify-center w-8 h-8 transition-all duration-200 ease-linear rounded-md bg-slate-100 text-slate-500 hover:text-custom-500 hover:bg-custom-100 dark:bg-zink-600 dark:text-zink-200 dark:hover:bg-custom-500/20 dark:hover:text-custom-500"
                                       href="{{ url('pages-account') }}">
                                        <i data-lucide="eye" class="inline-block w-4 h-4"></i> </a>
                                    ...
                                    <a href="#!" data-modal-target="deleteModal{{$index}}"
                                       class="flex items-center justify-center w-8 h-8 transition-all duration-200 ease-linear rounded-md remove-item-btn bg-slate-100 text-slate-500 hover:text-custom-500 hover:bg-custom-100 dark:bg-zink-600 dark:text-zink-200 dark:hover:bg-custom-500/20 dark:hover:text-custom-500">
                                        <i data-lucide="trash-2"
                                           class="inline-block w-4 h-4 text-red-500 fill-red-100 dark:fill-red-500/20"></i>
                                    </a>
                                </div>
                            </td>
                        </tr>
                            ...
                            <div class="w-screen md:w-[25rem] bg-white shadow rounded-md dark:bg-zink-600">
                                <div class="max-h-[calc(theme('height.screen')_-_180px)] overflow-y-auto px-6 py-8">
                                    ...
                                    <div class="mt-5 text-center">
                                        {{ Form::open(['route' => ['produto.deletar', $produto->id], 'method' => 'delete']) }}
                                        <h5 class="mb-1">Tem certeza?</h5>
                                        <p class="text-slate-500 dark:text-zink-200">Tem certeza de que deseja excluir
                                            este registro?</p>
                        ...
                        <div id="modalEditar{{$index}}" modal-center
                            ...
                            <div class="w-screen md:w-[30rem] bg-white shadow rounded-md dark:bg-zink-600">
                                ...
                                <div class="max-h-[calc(theme('height.screen')_-_180px)] p-4 overflow-y-auto">
                                    {{ Form::open(['route' => ['produto.atualizar', $produto->id], 'method' => 'put']) }}
                        ...
                        <div id="modalMovimentar{{$index}}" modal-center
                             class="fixed flex flex-col hidden transition-all duration-300 ease-in-out left-2/4 z-drawer -translate-x-2/4 -translate-y-2/4 show ">
                            <div class="w-screen md:w-[30rem] bg-white shadow rounded-md dark:bg-zink-600">
                                <div class="flex items-center justify-between p-4 border-b dark:border-zink-300/20">
                                    <h5 class="text-16">Movimentação do produto</h5>
                                    <button data-modal-close="modalMovimentar{{$index}}"
                                            class="transition-all duration-200 ease-linear text-slate-400 hover:text-red-500">
                                        <i data-lucide="x"
                                           class="w-5 h-5"></i></button>
                                </div>
                                <div class="max-h-[calc(theme('height.screen')_-_180px)] p-4 overflow-y-auto">
                                    {{ Form::open(['route' => ['movimentacao.produto.salvar', $produto->id], 'method' => 'post']) }}
                                    <div class="mb-3">
                                        <label for="id_tipo_movimentacao" class="inline-block mb-2 text-base font-medium">Tipo movimentação</label>
                                        <select
                                            class="form-input border-slate-200 dark:border-zink-500 focus:outline-none focus:border-custom-500 disabled:bg-slate-100 dark:disabled:bg-zink-600 disabled:border-slate-300 dark:disabled:border-zink-500 dark:disabled:text-zink-200 disabled:text-slate-500 dark:text-zink-100 dark:bg-zink-700 dark:focus:border-custom-800 placeholder:text-slate-400 dark:placeholder:text-zink-200"
                                            name="id_tipo_movimentacao" id="choices-single-default">
                                    ...
                                    <div class="mb-3">
                                        <label for="quantidade" class="inline-block mb-2 text-base font-medium">Quantidade movimentação: </label>
                                        <input type="text" id="nome" name="quantidade"
                                               class="form-input border-slate-200 dark:border-zink-500 focus:outline-none focus:border-custom-500 disabled:bg-slate-100 dark:disabled:bg-zink-600 disabled:border-slate-300 dark:disabled:border-zink-500 dark:disabled:text-zink-200 disabled:text-slate-500 dark:text-zink-100 dark:bg-zink-700 dark:focus:border-custom-800 placeholder:text-slate-400 dark:placeholder:text-zink-200"
                                               placeholder="200" required>
                                    </div>

                                    <div class="flex justify-end gap-2 mt-4">
                                        <button type="reset" data-modal-close="modalMovimentar{{$index}}"
                                                class="text-red-500 transition-all duration-200 ease-linear bg-white border-white btn hover:text-red-600 focus:text-red-600 active:text-red-600 dark:bg-zink-500 dark:border-zink-500">
                                            Cancelar
                                        </button>
                                        <button type="submit"
                ...
                <div class="noresult" style="display: none">
                    <div class="py-6 text-center">
                        ...
                        <p class="mb-0 text-slate-500 dark:text-zink-200">We've searched more than 199+ product We did
                            not
    ...
    <div id="produtoModal" modal-center
        ...
        <div
            ...
            {{ Form::open(['route' => 'produto.salvar', 'method' => 'post']) }}
            <div class="max-h-[calc(theme('height.screen')_-_180px)] p-4 overflow-y-auto">
                ...
                <div class="mb-3">
                    <label for="id_categoria" class="inline-block mb-2 text-base font-medium">Categoria</label>
                    <select
                        class="form-input border-slate-200 dark:border-zink-500 focus:outline-none focus:border-custom-500 disabled:bg-slate-100 dark:disabled:bg-zink-600 disabled:border-slate-300 dark:disabled:border-zink-500 dark:disabled:text-zink-200 disabled:text-slate-500 dark:text-zink-100 dark:bg-zink-700 dark:focus:border-custom-800 placeholder:text-slate-400 dark:placeholder:text-zink-200"
                        data-choices name="id_categoria" id="choices-single-default">
                ...
                <div class="mb-3">
                    <label for="preco" class="inline-block mb-2 text-base font-medium">Preço</label>
                    <input type="text" id="nome" name="preco"
                           class="form-input border-slate-200 dark:border-zink-500 focus:outline-none focus:border-custom-500 disabled:bg-slate-100 dark:disabled:bg-zink-600 disabled:border-slate-300 dark:disabled:border-zink-500 dark:disabled:text-zink-200 disabled:text-slate-500 dark:text-zink-100 dark:bg-zink-700 dark:focus:border-custom-800 placeholder:text-slate-400 dark:placeholder:text-zink-200"
                           placeholder="R$00,00" required>
                </div>

                <div class="mb-3">
                    <label for="quantidade_em_estoque" class="inline-block mb-2 text-base font-medium">Quantidade em estoque</label>
                    <input type="text" id="nome" name="quantidade_em_estoque"
                           class="form-input border-slate-200 dark:border-zink-500 focus:outline-none focus:border-custom-500 disabled:bg-slate-100 dark:disabled:bg-zink-600 disabled:border-slate-300 dark:disabled:border-zink-500 dark:disabled:text-zink-200 disabled:text-slate-500 dark:text-zink-100 dark:bg-zink-700 dark:focus:border-custom-800 placeholder:text-slate-400 dark:placeholder:text-zink-200"
                           placeholder="200" required>
                </div>
            ...
            <div
                ...
                <div class="flex justify-end gap-2 mt-4">
                    <button type="reset" data-modal-close="produtoModal"
                            class="text-red-500 transition-all duration-200 ease-linear bg-white border-white btn hover:text-red-600 focus:text-red-600 active:text-red-600 dark:bg-zink-500 dark:border-zink-500">
                        Cancelar
                    </button>
                    <button type="submit"
